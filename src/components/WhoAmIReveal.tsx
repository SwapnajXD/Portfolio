        ...
        >
          ...
          >
            <span className="retro-marquee inline-block text-xs font-bold text-[#FFCC00]">
              🚧 UNDER CONSTRUCTION 🚧 BEST VIEWED IN INTERNET EXPLORER 5.0
              AT 800x600 🚧 SIGN MY GUESTBOOK 🚧 DIAL-UP FRIENDLY 🚧
            </span>
          </div>
          ...
          <div style={{ padding: "0 16px 16px" }}>
            ...
            <p style={{ textAlign: "center", color: "#CC0000", fontSize: 12 }}>
              ...
              color and a hit counter{" "}
              <span className="retro-blink">★ NEW ★</span>
            </p>

            <hr style={{ border: "none", borderTop: "1px solid #CCCCCC" }} />

            <p style={{ color: "#000000", lineHeight: 1.6, fontSize: 13 }}>
              Hi and welcome to my page! I am Swapnaj and I like clouds ☁️
              (the AWS kind, not the sky kind) and devops and building cool
              stuff. This site is optimized for a 56k modem, so please be
            ...
            >
              ...
              <br />
              <span style={{ fontSize: 28, letterSpacing: 4, color: "#00FF00" }}>
                001337
              </span>
              <br />
            ...
            >
              <p
                style={{ color: "#003399", margin: "0 0 6px", fontWeight: "bold", fontSize: 13 }}
              >
                📖 guestbook
              </p>
              <p style={{ color: "#000000", fontSize: 12, margin: "0 0 4px" }}>
                <b style={{ color: "#0000EE" }}>xX_h4x0r_Xx</b> wrote: nice
                site dude, 5 stars ⭐⭐⭐⭐⭐
              </p>
              <p style={{ color: "#000000", fontSize: 12, margin: "0 0 4px" }}>
                <b style={{ color: "#0000EE" }}>anonymous</b> wrote: how do i
                leave a message here
              </p>
              <p style={{ color: "#000000", fontSize: 12, margin: 0 }}>
                <b style={{ color: "#0000EE" }}>swapnaj</b> wrote: you
            ...
            >
              ...
              <ol style={{ color: "#0000EE", fontSize: 12, margin: 0, paddingLeft: 20 }}>
                ...
                <li style={{ textDecoration: "underline" }}>
                  Encarta 98 — all the world&apos;s knowledge, on 4 CDs
                </li>
                <li style={{ textDecoration: "underline" }}>Neopets</li>
                <li style={{ textDecoration: "underline" }}>
                  my geocities neighbor&apos;s site (also under construction)
                </li>
              </ol>
            </div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <ul style={{ color: "#000000", fontSize: 12, margin: 0, paddingLeft: 20 }}>
                <li>
                  <span className="retro-blink">★</span> i once fixed a prod
                  outage at 3am and lived to tell the tale
                </li>
                <li>
                  <span className="retro-blink">★</span> my homelab has
                  better uptime than most startups
                </li>
                <li>
                  <span className="retro-blink">★</span> this page took
                  longer to build than some of my real projects
                </li>
              </ul>
            </div>
            ...
            <p style={{ textAlign: "center", fontSize: 10, color: "#999999" }}>
              this page has been visited by aliens 👽 (unconfirmed, pending
              peer review)
            </p>

            <p style={{ textAlign: "center", fontSize: 11, color: "#666666" }}>
              © 1999-2026 swapnaj&apos;s homepage. last updated: whenever i
              felt like it. webmaster:{" "}
  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-3xl flex-col justify-center px-6 py-16 font-mono text-sm">
      ...
      <p className="mt-2 text-text-primary">
        ...
        drwxr-xr-x  journal/
        <br />
        <span className="text-text-muted">drwx------  .neocities/</span>
